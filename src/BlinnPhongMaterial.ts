...
export default class BlinnPhongMaterial extends Material {
    ...
    blinnphong_material_bind_group: GPUBindGroup;
    ...
    initializeBindGroup() {
        ...
        this.blinnphong_material_bind_group = this.device.createBindGroup({
            layout: ShaderUtility.BindGroupLayoutList.blinnphong_material_bind_group_layout,
            entries: [
                {
                    binding: 0,
    ...
    setBindGroups(device: GPUDevice, passEncoder: GPURenderPassEncoder) {
        ...
        passEncoder.setBindGroup(3, this.blinnphong_material_bind_group);
    }
